#Exportation of the 2 qubits example plots.
...
anim0[0].save("exports/animations/2q_noiseless_A.gif", writer="pillow", fps=40)
anim0[1].save("exports/animations/2q_noiseless_B.gif", writer="pillow", fps=40)
plt.close()

anim = animate_trajectory_2q(pts_A,  pts_B,  interval_ms=20)
anim0[0].save("exports/animations/2q_noisy.gif", writer="pillow", fps=40)
anim0[1].save("exports/animations/2q_nois_B.gif", writer="pillow", fps=40)
plt.close()
